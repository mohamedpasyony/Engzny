...
namespace Engzny.Migrations
{
    ...
    [Migration("20230316220056_OrderMig1")]
    partial class OrderMig1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Engzny.Models.Order_Status", b =>
                {
            ...
            modelBuilder.Entity("Engzny.Models.Order_Status", b =>
                {
                    b.HasOne("Engzny.Models.Order", "order")
                        .WithMany("Order_Statuses")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Engzny.Models.OrderStatus", "status")
                        .WithMany("Order_Statuses")
